...
CREATE DATABASE IF NOT EXISTS `farm_management` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_uca1400_ai_ci */;
USE `farm_management`;
...
CREATE TABLE IF NOT EXISTS `attendance` (
  ...
  CONSTRAINT `1` FOREIGN KEY (`employment_id`) REFERENCES `employment` (`employment_id`),
...
CREATE TABLE IF NOT EXISTS `crop` (
  `crop_id` char(36) NOT NULL DEFAULT uuid(),
  ...
  PRIMARY KEY (`crop_id`),
  KEY `farm_id` (`farm_id`),
  CONSTRAINT `1` FOREIGN KEY (`farm_id`) REFERENCES `farm` (`farm_id`),
...
CREATE TABLE IF NOT EXISTS `crop_disease` (
  ...
  CONSTRAINT `1` FOREIGN KEY (`crop_id`) REFERENCES `crop` (`crop_id`),
  CONSTRAINT `2` FOREIGN KEY (`disease_id`) REFERENCES `disease` (`disease_id`),
...
CREATE TABLE IF NOT EXISTS `employment` (
  `employment_id` char(36) NOT NULL DEFAULT uuid(),
  ...
  KEY `user_id` (`user_id`),
  KEY `farm_id` (`farm_id`),
  CONSTRAINT `1` FOREIGN KEY (`user_id`) REFERENCES `app_user` (`user_id`),
  CONSTRAINT `2` FOREIGN KEY (`farm_id`) REFERENCES `farm` (`farm_id`),
...
CREATE TABLE IF NOT EXISTS `equipment` (
  `equipment_id` char(36) NOT NULL DEFAULT uuid(),
  `farm_id` char(36) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `equipment_maintenance` (
  ...
  CONSTRAINT `1` FOREIGN KEY (`equipment_id`) REFERENCES `equipment` (`equipment_id`),
...
CREATE TABLE IF NOT EXISTS `equipment_usage` (
  ...
  CONSTRAINT `1` FOREIGN KEY (`equipment_id`) REFERENCES `equipment` (`equipment_id`),
  CONSTRAINT `2` FOREIGN KEY (`employment_id`) REFERENCES `employment` (`employment_id`),
...
CREATE TABLE IF NOT EXISTS `farm` (
  `farm_id` char(36) NOT NULL DEFAULT uuid(),
...
CREATE TABLE IF NOT EXISTS `fertilizer` (
  `fertilizer_id` char(36) NOT NULL DEFAULT uuid(),
...
CREATE TABLE IF NOT EXISTS `fertilizer_application` (
  ...
  CONSTRAINT `1` FOREIGN KEY (`crop_id`) REFERENCES `crop` (`crop_id`),
  CONSTRAINT `2` FOREIGN KEY (`employment_id`) REFERENCES `employment` (`employment_id`),
  CONSTRAINT `3` FOREIGN KEY (`fertilizer_id`) REFERENCES `fertilizer` (`fertilizer_id`),
...
CREATE TABLE IF NOT EXISTS `fertilizer_transaction` (
  ...
  KEY `fertilizer_id` (`fertilizer_id`),
  CONSTRAINT `1` FOREIGN KEY (`fertilizer_id`) REFERENCES `fertilizer` (`fertilizer_id`),
...
CREATE TABLE IF NOT EXISTS `sale_item` (
  `sale_item_id` char(36) NOT NULL DEFAULT uuid(),
  `sale_id` char(36) NOT NULL,
  `inventory_id` char(36) NOT NULL,
  `quantity` decimal(12,2) NOT NULL,
  `unit_price` decimal(10,2) NOT NULL,
  ...
  KEY `sale_id` (`sale_id`),
  KEY `inventory_id` (`inventory_id`),
  CONSTRAINT `1` FOREIGN KEY (`sale_id`) REFERENCES `sale` (`sale_id`),
  CONSTRAINT `2` FOREIGN KEY (`inventory_id`) REFERENCES `inventory` (`inventory_id`),
